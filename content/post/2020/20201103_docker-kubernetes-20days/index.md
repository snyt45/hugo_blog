...
- ch04/todoweb:latest という名前でイメージをビルド
...
- Dockerfile の名前が普段と違うので、-f でファイル名を指定してイメージをビルド
...
- todo_frontend_nginx コンテナの/var/www/\_nuxt ディレクトリのファイル一覧を取得
